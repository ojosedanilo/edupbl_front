    ...
    >
      <div className="flex min-w-0 items-center gap-3 md:gap-4">
        ...
        <div className="min-w-0 text-sm font-semibold leading-tight text-text md:text-lg">
          <p className="text-light mb-0">ESCOLA ESTADUAL DE EDUCAÇÃO</p>
          <p className="text-light ">PROFISSIONAL PAULO BARBOSA LEITE</p>
        </div>
      </div>
      <Link
        to={user ? "/inicio" : "/entrar"}
        className="shrink-0 rounded-full bg-bg px-6 py-2 text-sm font-semibold text-text transition-all hover:opacity-90 md:text-base"
      >
