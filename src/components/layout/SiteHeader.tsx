  ...
  return (
    ...
    >
      <div className="flex min-w-0 items-center gap-3 md:gap-4">
        ...
        />
        <div className="min-w-0 text-sm font-semibold leading-tight text-text-reverse md:text-lg">
      ...
      <Link
        ...
        className="shrink-0 rounded-full bg-accent px-6 py-2 text-sm font-semibold text-text-reverse transition-all hover:opacity-90 md:text-base"
      >
