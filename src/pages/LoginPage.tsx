...
export default function LoginPage() {
  ...
  return (
    <div className="relative min-h-screen w-full flex items-center justify-center overflow-hidden">
      ...
      {/* GRADIENTE POR CIMA */}
      <div className="absolute inset-0 bg-gradient-to-r from-[#266634]/90 to-[#ffae00]/90" />
      ...
      <div className="relative z-10 w-full flex items-center justify-center p-6">
        ...
        <div className="flex w-full max-w-6xl overflow-hidden rounded-[30px] shadow-2xl flex-col lg:flex-row">
          ...
          {/* LADO DIREITO */}
          <div className="flex flex-1 flex-col items-center justify-center gap-8 px-8 py-16 bg-white/90 backdrop-blur-md shadow-[inset_0_0_0_1px_rgba(0,0,0,0.05),0_20px_60px_rgba(0,0,0,0.25)]">
            ...
            >
              <TextField
                ...
                required
                aria-label="E-mail"
                className="h-14 rounded-full border-2 border-green-900"
              />
